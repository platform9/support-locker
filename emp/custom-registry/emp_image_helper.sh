...
IMAGES="$IMAGES public.ecr.aws/platform9/evm-vpc-cni:1.1.121"
IMAGES="$IMAGES public.ecr.aws/platform9/evm-vpc-cni-init:1.1.121"
...
#Charts
IMAGES="$IMAGES public.ecr.aws/platform9/emp-helm-charts/eks-cluster-chart:1.1.775"
IMAGES="$IMAGES public.ecr.aws/platform9/emp-helm-charts/baremetal-chart:1.1.893"
