...
IMAGES="$IMAGES public.ecr.aws/platform9/kubevirt/cdi-apiserver:v1.59.1"
IMAGES="$IMAGES public.ecr.aws/platform9/evm-stack-controller-manager:1.0.369"
IMAGES="$IMAGES public.ecr.aws/platform9/pmk-vpc-cni:1.1.147"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-exportproxy:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/fedora-with-test-tooling-container-disk:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/disks-images-provider:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/network-slirp-binding:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/emp-pmk-init:1.1.183"
IMAGES="$IMAGES public.ecr.aws/platform9/eks-vol-watcher:1.0.369"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-controller:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-handler:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-exportserver:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/pr-helper:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/example-cloudinit-hook-sidecar:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/cirros-custom-container-disk-demo:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/virtio-container-disk:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/alpine-ext-kernel-boot-demo:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/alpine-with-test-tooling-container-disk:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/cni-metrics-helper:1.1.147"
IMAGES="$IMAGES public.ecr.aws/platform9/emp-helm-charts/eks-cluster-chart:1.1.704"
IMAGES="$IMAGES public.ecr.aws/platform9/emp-webhook-eks:1.1.18"
IMAGES="$IMAGES public.ecr.aws/platform9/evm-vpc-cni:1.1.76"
IMAGES="$IMAGES public.ecr.aws/platform9/libguestfs-tools:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/example-hook-sidecar:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/example-disk-mutation-hook-sidecar:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/alpine-container-disk-demo:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/cirros-container-disk-demo:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/vm-killer:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/winrmcli:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/sidecar-shim:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/network-passt-binding:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/evm-autoscaler:1.1.123"
IMAGES="$IMAGES public.ecr.aws/platform9/emp-pod-webhook:1.1.216"
IMAGES="$IMAGES public.ecr.aws/platform9/pmk-vpc-cni-init:1.1.147"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-operator:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/evm-vpc-cni-init:1.1.76"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-api:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/virt-launcher:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/conformance:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/fedora-realtime-container-disk:1.1.186"
IMAGES="$IMAGES public.ecr.aws/platform9/nfs-server:1.1.186"
