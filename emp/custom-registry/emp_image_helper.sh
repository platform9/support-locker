...
IMAGES="$IMAGES public.ecr.aws/platform9/evm-vpc-cni:1.1.96"
IMAGES="$IMAGES public.ecr.aws/platform9/evm-vpc-cni-init:1.1.96"
...
#Charts
IMAGES="$IMAGES public.ecr.aws/platform9/emp-helm-charts/eks-cluster-chart:1.1.763"
IMAGES="$IMAGES public.ecr.aws/platform9/emp-helm-charts/baremetal-chart:1.1.883"
